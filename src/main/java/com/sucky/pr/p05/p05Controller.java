...
import com.sucky.pr.p05.model.Member;
...
public class p05Controller {
	...
	@GetMapping("/p05/pr02")
	public String pr02(Model model) {
	...
	@GetMapping("/p05/pr02_2")
	public String pr02_2(Model model){
	...
	@GetMapping("/p05/pr03")
	public String pr03(Model model) {
	...
	@GetMapping("/p05/pr04")
	public String pr04(Model model) {
